                ...
                <section className='work-section'>
                    <div className='work-dropdown' id='publications'>
                        ...
                        <div className={`work-paragraph-container ${isPublicationsVisible ? 'visible' : 'hidden'}`}>
                            <p className='work-paragraph'>[1] Y. Diaz, C. Gilbert, and R. Kinser, “Total stability and Auslander-Reiten theory for Dynkin quivers,” 2022, (Submitted for publication). arXiv: <a href='https://arxiv.org/abs/2208.02445' className='link research-link'>2208.02445.</a></p>
                            <p className='work-paragraph'>[2] C. Gilbert, “Moduli of Representations of Skewed-Gentle Algebras,” 2022, (Submitted for publication). arXiv: <a href='https://arxiv.org/abs/2208.00336' className='link research-link'>2208.00336.</a></p> 
                        </div>
                    ...
                    <div className='work-dropdown' id='invited-talks'>
                        ...
                        <div className={`work-paragraph-container ${isInvitedTalksVisible ? 'visible' : 'hidden'}`}>
                            ...
                            <p className='work-paragraph'>Moduli of Representations of Clannish Algebras, September 2022. Algebra and Geometry Seminar, Iowa State University <a href='https://drive.google.com/file/d/1VHBQxdamNLOVxzLZG9NWLLUBcdzRrn4g/view' className='link research-link'>(Slides).</a></p>
                            <p className='work-paragraph'>Moduli of Representations of Clannish Algebras, September 2022. <a href='https://www.fd-seminar.xyz/' className='link research-link'>FD Seminar</a> <a href='https://drive.google.com/file/d/1VHBQxdamNLOVxzLZG9NWLLUBcdzRrn4g/view' className='link research-link'>(Slides).</a></p>
                            ...
                            <p className='work-paragraph'>Moduli of Representations of Algebras, May 2021. AMS Special Session on Quivers, Tensors, and Their Applications <a href='https://drive.google.com/file/d/1yOp-VdrWYPCyNUkJRZ2RFr57QDexjW4x/view' className='link research-link'>(Slides).</a></p>
                        </div>
                    </div>
