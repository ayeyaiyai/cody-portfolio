            ...
            <section className='services-container'>
                ...
                <section className='services-body'>
                    <div className='service-instance'>
                        <p className='services-name'><a href='https://meetings.ams.org/math/fall2021c/meetingapp.cgi/Session/3832' className='link research-link'>AMS Sectional Meeting Special Session Organizer</a></p>
                    ...
                    <div className='service-instance right-align'>
                        <p className='services-name'><a href='https://sites.google.com/view/uiowadrp/home' className='link research-link'>Directed Reading Program</a></p>
                    ...
                    <div className='service-instance'>
                        <p className='services-name'><a href='https://math.uiowa.edu/graduate-program/math-graduate-board' className='link research-link'>Math Graduate Board</a> and <a href='https://gss.grad.uiowa.edu/' className='link research-link'>Graduate Student Senate</a></p>
                    ...
                    <div className='service-instance right-align'>
                        <p className='services-name'><a href='https://math.uiowa.edu/diversity-and-outreach/sonia-kovalevsky-high-school-mathematics-day' className='link research-link'>Sonia Kovalevsky High School Mathematics Day</a></p>
